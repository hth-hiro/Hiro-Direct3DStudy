...
void TutorialApp::Update()
{
    ...
    if (Miku)
    {
        Miku->transform.position = { 0, 0, 0 };
        Miku->transform.scale = { scaleValue };
        Miku->transform.rotation = { rotateValue.y, rotateValue.x, 0 };

        Miku->material.ambient = { 0, 0, 0, 0 };
        Miku->material.diffuse = { 1, 1, 1, 1 };
        Miku->material.specular = { 1, 1, 1, 1 };
        Miku->material.shininess = { 1000 };
    }
}
...
bool TutorialApp::InitScene()
{
    ...
    m_ModelLoader.Load(m_pDevice, m_pDeviceContext, "../Resource/Seifuku_ver2.0/MikuTureSailor.fbx", "Miku");
